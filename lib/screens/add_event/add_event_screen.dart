...
class _AddEventScreenState extends State<AddEventScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        leading: Icon(Icons.arrow_back, color: Color(0xFF5669FF),),
        title: Text(
          "Create Event",
          ...
          children: [
            ...
            Container(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  return ChipItem(
                    bg: selectedCategoryIndex == index  ? Color(0xFF5669FF) : Colors.transparent,
                    textColor: selectedCategoryIndex == index ? Colors.white : Color(0xFF5669FF),
              ...
              children: [
                ...
                GestureDetector(
                  ...
                  child: Text(
                    ...
                    style: TextStyle(fontSize: 18, color: Color(0xFF5669FF)),
                  ),
                ),
              ],
            ),
            ...
            Container(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(backgroundColor: Color(0xFF5669FF)),
                child: Text(
                  "Create Event",
